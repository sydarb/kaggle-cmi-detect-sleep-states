...
from src.config import PrepareDataConfig
...
def add_feature(series_df: pl.DataFrame) -> pl.DataFrame:
    series_df = (
        series_df.with_row_count("step").with_columns(
...
def main(cfg: PrepareDataConfig) -> None:
    processed_dir = Path(cfg.dir.processed_dir) / cfg.phase
    ...
    with trace("Save features"):
        for series_id, this_series_df in tqdm(series_df.group_by("series_id"), total=n_unique):
            ...
            series_dir: Path = processed_dir/series_id 
